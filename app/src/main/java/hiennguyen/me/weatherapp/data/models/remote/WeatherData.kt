...
@Entity
class Temp(@Id @Generated var id: Long, var day: Double?, var min: Double?, var max: Double?, var night: Int?, var eve: Double?, var morn:
Double?)

@Entity
class Weather(@Id @Generated var id: Long?, var main: String?, var description: String?, var icon: String?)

@Entity
data class ForeCast(@Id @Generated var id: Long, var dt: Int?, var temp: ToMany<Temp>, var pressure: Double?, var humidity: Int?,
